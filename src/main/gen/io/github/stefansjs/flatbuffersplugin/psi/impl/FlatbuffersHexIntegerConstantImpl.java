...
public class FlatbuffersHexIntegerConstantImpl extends ASTWrapperPsiElement implements FlatbuffersHexIntegerConstant {

  public FlatbuffersHexIntegerConstantImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlatbuffersVisitor visitor) {
    visitor.visitHexIntegerConstant(this);
  }
