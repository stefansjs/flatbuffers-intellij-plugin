...
public class FlatbuffersBooleanConstantImpl extends ASTWrapperPsiElement implements FlatbuffersBooleanConstant {

  public FlatbuffersBooleanConstantImpl(@NotNull ASTNode node) {
    super(node);
  }
