...
public class FlatbuffersFieldIdentImpl extends ASTWrapperPsiElement implements FlatbuffersFieldIdent {

  public FlatbuffersFieldIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlatbuffersVisitor visitor) {
    visitor.visitFieldIdent(this);
  }
