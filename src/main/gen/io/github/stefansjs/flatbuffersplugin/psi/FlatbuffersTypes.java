...
import io.github.stefansjs.flatbuffersplugin.psi.impl.*;
...
public interface FlatbuffersTypes {
  ...
  IElementType FIELD_VALUE = new FlatbuffersElementType("FIELD_VALUE");
