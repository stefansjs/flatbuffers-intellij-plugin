...
public class FlatbuffersDecIntegerConstantImpl extends ASTWrapperPsiElement implements FlatbuffersDecIntegerConstant {

  public FlatbuffersDecIntegerConstantImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FlatbuffersVisitor visitor) {
    visitor.visitDecIntegerConstant(this);
  }
  ...
  public PsiElement getDecInteger() {
    return findNotNullChildByType(DEC_INTEGER);
  }
